...
\begin{table}[t]
\caption{Ablation results as percentage NRMSE reduction from Plain Delta. ``Random'' is a fixed random rank-four subspace; ``Dual'' is the state-matched query--write control; ``best \QDDD'' reports the best tested rank by test mean for interpretation, while headline ranks in Table~\ref{tab:main} were selected on validation data.}
\label{tab:ablation}
\centering
\scriptsize
...
\toprule
Workload & Diag. & Last & Random & Dual & Best \QDDD & Full \\
\midrule
Spatial, concentrated & $-0.82$ & $16.09$ & $-0.64$ & $18.40$ & $31.73$ ($r=4$) & $30.91$ \\
Source-token profiles & $18.30$ & $20.12$ & $1.70$ & $8.84$ & $20.53$ ($r=1$) & $20.40$ \\
Module-import graph & $27.50$ & $30.71$ & $3.00$ & $10.06$ & $32.65$ ($r=1$) & $32.37$ \\
\bottomrule
\end{tabular}
\end{table}
